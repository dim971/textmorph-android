...
[the catalogue](showcase/src/main/kotlin/io/github/dim971/textmorph/showcase/catalog/Catalog.kt)
says so. The last two are ours: the first value a view renders, which never
animates, and a value emptying out.
