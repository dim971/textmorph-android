    ...
    Demo(
        ...
        summary =
            "Two pills on one track, each morphing its own value, and each in the other's " +
                "way. Drag them together and the lower one lifts clear so both stay readable. " +
                "Upstream leans them apart about their tails instead, solving a collision test every " +
                "frame; the morph is the same either way, and this is the part of the card that is " +
